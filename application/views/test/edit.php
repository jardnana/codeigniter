...
<body>
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
            <br/><br/><br/><br/><br/>
                  <div class="row justify-content-center"><h2 class="text-align-center"> Edit Product Details </h2></div>
                  <?php //echo "<pre>product_details";print_r($product_details);die; ?>
                    <?php echo form_open_multipart('Login_test/edit_details/'.$product_details[0]['id']); ?>
                            <div class="form-group row">
                                <label for="category" class="col-md-4">Category:</label>
                                <div class="col-md-6">
                                    <select name="category" class="select_ids" width="10%">
                                     <?php foreach ($cat as $key => $value) {
                                      if($value['category'] == $product_details[0]['category']){ ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="product" width="10%" class="app_list">
                                      ...
                                      if($value['product'] == $product_details[0]['product']){ ?>
                                        <option selected value="<?php echo $value['product']; ?>"><?php echo $value['product']; ?></option>
                                        <?php } else { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="price" class="form-control" name="price" value="<?php echo $product_details[0]['price']; ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="price" class="col-md-4">Quantity:</label>
                                <div class="col-md-6">
                                    <input type="text" id="quantity" class="form-control" name="quantity" value="<?php echo $product_details[0]['quantity']; ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                    <img src="<?php echo $product_details[0]['img_path']; ?>" alt="error In display" height="42" width="42">
